...
open_file.exe "C:\Users\IEUser\Desktop\atlassian-servicedesk-3.5.0-x32.exe" %windowTitle% "1-openfile"
...
enter_text.exe %windowTitle% "-custom-folder" "6 -custom folder - click textfield" 
...
enter_text.exe %windowTitle% "{DEL 4}" "12 -custom folder - click textfield" 
enter_text.exe %windowTitle% "991" "13 -custom folder - click textfield" 
